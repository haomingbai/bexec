...
struct set_value_t {
  ...
  constexpr void operator()(Receiver&& receiver,
 ...
 */
template <class Receiver>
concept receiver = std::move_constructible<std::remove_cvref_t<Receiver>>;
...
template <class Receiver, class Completions>
concept receiver_of =
    valid_completion_signatures<Completions> && receiver<Receiver> &&
